...
Namebot = AVIRA_Msg[math.random(#AVIRA_Msg)] 
...
os.execute('wget https://raw.githubusercontent.com/devid100/po/main/AVIRA.lua')
...
send(msg.chat_id_, msg.id_,' ◉ اصدار سورس افايره { 2x }')
end
...
os.execute('rm -rf AVIRA.lua')
os.execute('wget https://raw.githubusercontent.com/Ffasit/photo/main/AVIRA.lua')
send(msg.chat_id_, msg.id_,' ◉ تم تحديث السورس')
dofile('AVIRA.lua')  
end
